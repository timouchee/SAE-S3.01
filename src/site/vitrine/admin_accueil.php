<p id="title_up">administration</p>
...
<div id="lst_but">
    ...
    <br><br><br>
    <button type="button" class="but_admin_lst">Réinitialiser les <br> préférences utilisateurs</button>
    <br><br><br>
    <button type="button" class="but_admin_lst">aider un utilisateur</button>
</div>  